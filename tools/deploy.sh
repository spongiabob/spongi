...
deploy() {
  git config --global user.name "spongiabob" #"GitHub Actions"
  git config --global user.email "1091376095@qq.com"#"41898282+github-actions[bot]@users.noreply.github.com"
